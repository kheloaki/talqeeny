...
const steps = [
  ...
  },
  {
    ...
    description: "Pratique guidée : lecture, écriture, vocabulaire avec correction immédiate."
  },
  {
    title: "Suivi personnalisé",
    description: "Corrections + plan de révision simple pour consolider vos acquis."
  }
];

export default function ArabicHowItWorks() {
  return (
      ...
      <div className="container px-6 mx-auto max-w-[1240px]">
        <div className="text-center mb-16">
          ...
          <p className="text-[#5E6266] text-[18px] max-w-[700px] mx-auto font-inter">
            Un processus simple et transparent pour commencer votre apprentissage de l'arabe.
          </p>
        </div>
