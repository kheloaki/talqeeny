...
export default function ArabicLeadMagnet() {
  return (
          ...
          <div className="absolute bottom-0 right-0 w-40 h-40 bg-white/5 blur-3xl -mr-20 -mb-20 rounded-full"></div>
            ...
            <div className="lg:max-w-[500px] relative z-10">
              ...
              <h2 className="text-white/90 text-[32px] md:text-[42px] font-bold mb-6 leading-[1.2] font-poppins">
                Recevez le guide Alphabet Arabe (PDF)
              </h2>
            <p className="text-white/90 text-[18px] mb-8 leading-[1.6] font-inter">
              Une méthode simple pour démarrer : sons, lettres et premières lectures. Parfait pour apprendre l'arabe en douceur.
            </p>
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                ...
                <p className="text-white/80 text-sm font-inter">Alphabet arabe pour débutants</p>
              </div>
            </div>
          </div>

          <div className="w-full lg:max-w-[450px] bg-white p-8 md:p-10 rounded-[40px] shadow-xl relative z-10">
            <h3 className="text-[#003049] text-[22px] font-bold mb-6 font-poppins">Recevoir le guide par email</h3>
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              >
                Recevoir le guide <Send className="w-5 h-5" />
              </button>
