...
const teachers = [
  {
    name: "Pr. Abdellah",
    expertise: "ARABE & PÉDAGOGIE",
    description: "Pédagogie claire pour francophones, corrections en direct, progression structurée. Il accompagne ses élèves avec rigueur et bienveillance."
  },
  {
    name: "Pr. Ihsane",
    expertise: "ARABE & ÉDUCATION",
...
export default function ArabicTeachers() {
  return (
        ...
        <div className="bg-[#F0FAFB] rounded-[40px] md:rounded-[60px] p-8 md:p-16">
            <div className="text-center mb-16">
              ...
              <p className="text-[#5E6266] text-[18px] max-w-[700px] mx-auto font-inter">
                Nos enseignants sont sélectionnés pour leur pédagogie et leur expérience dans l'enseignement de l'arabe aux francophones.
              </p>
            </div>
