...
const formats = [
  {
  ...
  },
    {
      ...
      description: "Un professeur rien que pour vous. Idéal pour avancer plus vite avec la méthode Nourania."
    }
];

export default function NouraniaFormats() {
  return (
      ...
      <div className="container px-6 mx-auto max-w-[1240px]">
        ...
        <div className="mt-16 text-center">
          <p className="text-[#5E6266] text-[16px] italic font-inter">
            Vous hésitez ? <a href="#pricing-plans" className="text-[#29ABE2] font-bold hover:underline">Faites le test de niveau</a> pour en discuter avec nous.
          </p>
        </div>
      </div>
    </section>
