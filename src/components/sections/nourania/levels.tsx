...
const steps = [
  {
    level: "Niveau 1",
    title: "Lettres & voyelles",
    outcomes: [
      "Reconnaître et prononcer les lettres arabes",
      "Comprendre les voyelles (harakat)",
  ...
  },
  {
    ...
    outcomes: [
      "Assembler les lettres en syllabes",
      "Lire des mots simples puis complexes",
      "Gagner en fluidité de lecture"
    ]
  },
  {
    level: "Niveau 3",
    title: "Lecture vers le Coran",
    outcomes: [
      "Lecture fluide et autonome",
      "Préparation à la lecture coranique",
      "Bases du tajwîd (optionnel)"
    ]
  }
];

export default function NouraniaLevels() {
  return (
      ...
      <div className="container px-6 mx-auto max-w-[1240px]">
        <div className="text-center mb-16">
          ...
          <p className="text-[#5E6266] text-[18px] max-w-[700px] mx-auto font-inter">
            Progressez étape par étape avec la méthode Nourania vers la lecture du Coran.
          </p>
        </div>
