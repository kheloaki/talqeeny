...
const results = [
  {
    ...
    description: "La majorité de nos élèves constatent une amélioration nette de leur fluidité en lecture dès les premières semaines avec la méthode Nourania."
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description: "Nos élèves gagnent en confiance pour aborder la lecture du Coran sereinement après avoir maîtrisé la Qaida Nourania."
  }
];

export default function NouraniaResults() {
  return (
      ...
      <div className="container px-6 mx-auto max-w-[1240px]">
        <div className="text-center mb-16">
          ...
          <p className="text-[#5E6266] text-[18px] max-w-[700px] mx-auto font-inter">
            Des progrès visibles et une motivation renouvelée au fil des séances avec la méthode Nourania.
          </p>
        </div>
