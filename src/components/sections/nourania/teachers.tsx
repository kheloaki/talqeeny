...
const teachers = [
  ...
  {
    name: "Pr. Ihsane",
    expertise: "NOURANIA & TAJWÎD",
    description: "Pédagogie claire pour francophones, corrections en direct, progression structurée. Elle enseigne la méthode Nourania avec une approche adaptée à tous les profils."
  },
  {
    name: "Pr. Doae",
    expertise: "NOURANIA & PÉDAGOGIE",
    description: "Pédagogie claire pour francophones, corrections en direct, progression structurée. Elle accompagne les élèves vers une maîtrise solide de la lecture coranique."
  }
];

export default function NouraniaTeachers() {
  return (
        ...
        <div className="bg-[#F0FAFB] rounded-[40px] md:rounded-[60px] p-8 md:p-16">
            <div className="text-center mb-16">
              ...
              <p className="text-[#5E6266] text-[18px] max-w-[700px] mx-auto font-inter">
                Nos enseignants sont sélectionnés pour leur pédagogie et leur expérience dans l'enseignement de la méthode Nourania aux francophones.
              </p>
            </div>
